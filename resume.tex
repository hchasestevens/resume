...
Anticipated degree classification: First-class honours (GPA equivalent: 3.86/4.00)\\
...
\item Delivered and assisted in implementing roadmap for Selenium WebDriver-based browser automation and web scraper framework in Python
